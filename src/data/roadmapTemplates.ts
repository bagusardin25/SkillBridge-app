...
export const roadmapTemplates: RoadmapTemplate[] = [
    {
        ...
        roadmap: {
            ...
            edges: [
                ...
                { id: "e3", source: "js-basics", target: "responsive" },
                { id: "e4", source: "responsive", target: "git" },
                { id: "e5", source: "git", target: "react" },
                { id: "e6", source: "react", target: "tailwind" },
                { id: "e7", source: "tailwind", target: "project" },
            ],
        },
    },
    {
        ...
        roadmap: {
            ...
            edges: [
                ...
                { id: "e4", source: "sql", target: "mongodb" },
                { id: "e5", source: "mongodb", target: "auth" },
    ...
    },
    {
        ...
        roadmap: {
            ...
            edges: [
                ...
                { id: "e4", source: "matplotlib", target: "statistics" },
                { id: "e5", source: "statistics", target: "sklearn" },
                { id: "e6", source: "sklearn", target: "project" },
            ],
        },
    },
    {
        ...
        roadmap: {
            ...
            edges: [
                ...
                { id: "e4", source: "navigation", target: "state" },
                { id: "e5", source: "state", target: "native-modules" },
                { id: "e6", source: "native-modules", target: "project" },
            ],
        },
    },
    {
        ...
        roadmap: {
            ...
            edges: [
                ...
                { id: "e3", source: "figma", target: "ux-research" },
                { id: "e4", source: "ux-research", target: "wireframing" },
                { id: "e5", source: "wireframing", target: "design-system" },
                { id: "e6", source: "design-system", target: "project" },
            ],
        },
    },
];
